...
public class SeaFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "sea";
    private Random random = new Random();
    private int current_page = random.nextInt(10);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_sea_frag);
        context = this;

        toolbar = findViewById(R.id.toolbar_sea_f);
        setSupportActionBar(toolbar);
        progressBar = findViewById(R.id.progress_bar_sea_frag);
        recyclerView = findViewById(R.id.recycler_view_homeCate);
