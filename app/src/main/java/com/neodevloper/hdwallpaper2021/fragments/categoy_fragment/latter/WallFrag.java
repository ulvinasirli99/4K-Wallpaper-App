package com.neodevloper.hdwallpaper2021.fragments.categoy_fragment.latter;
...
public class WallFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "wall color";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_wall_frag);
        context = this;

        recyclerView = findViewById(R.id.recycler_view_wall_frag);
        progressBar = findViewById(R.id.progress_bar_wall_frag);
        toolbar = findViewById(R.id.toolbar_wall_f);
