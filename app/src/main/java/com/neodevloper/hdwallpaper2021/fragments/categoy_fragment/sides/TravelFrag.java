...
public class TravelFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "travel";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_travel_frag);
        context = this;

        recyclerView = findViewById(R.id.recycler_view_tra_frag);
        progressBar = findViewById(R.id.progress_bar_tra_frag);
        toolbar = findViewById(R.id.toolbar_travel_f);
