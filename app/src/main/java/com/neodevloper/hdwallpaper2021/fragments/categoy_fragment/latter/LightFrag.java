...
public class LightFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "light";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_light_frag);

        context = this;

        recyclerView = findViewById(R.id.recycler_view_light_frag);
        progressBar = findViewById(R.id.progress_bar_light_frag);
        toolbar = findViewById(R.id.toolbar_light_f);
