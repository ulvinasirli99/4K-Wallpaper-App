...
public class CloudFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "cloud";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_cloud_frag);

        context = this;

        recyclerView = findViewById(R.id.recycler_view_cloud_frag);
        progressBar = findViewById(R.id.progress_bar_cloud_frag);
        toolbar = findViewById(R.id.toolbar_cloud_f);
