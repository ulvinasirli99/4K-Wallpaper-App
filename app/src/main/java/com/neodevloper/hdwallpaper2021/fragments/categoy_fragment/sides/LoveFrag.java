...
public class LoveFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "love";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_love_frag);
        context = this;

        progressBar = findViewById(R.id.progress_bar_love_frag);
        recyclerView = findViewById(R.id.recycler_view_car_frag);
        layoutManager = new GridLayoutManager(context, 3);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setHasFixedSize(true);
        toolbar = findViewById(R.id.toolbar_love_f);
