...
public class SpaceFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "space";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_space_frag);
        context = this;

        recyclerView = findViewById(R.id.recycler_view_spa_frag);
        progressBar = findViewById(R.id.progress_bar_spa_frag);
        toolbar = findViewById(R.id.toolbar_space_f);
