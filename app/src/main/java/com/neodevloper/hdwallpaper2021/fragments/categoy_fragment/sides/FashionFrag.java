...
public class FashionFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "fashion";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_fashion_frag);
        context = this;
        recyclerView = findViewById(R.id.recycler_view_fash_frag);
        progressBar = findViewById(R.id.progress_bar_fash_frag);
        toolbar = findViewById(R.id.toolbar_fash_f);
