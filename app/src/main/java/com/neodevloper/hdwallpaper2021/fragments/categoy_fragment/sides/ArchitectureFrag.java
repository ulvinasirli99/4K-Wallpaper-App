package com.neodevloper.hdwallpaper2021.fragments.categoy_fragment.sides;
...
public class ArchitectureFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "architecture";
    ...
    private String key = "lYzXn5blWy12CA5fbaTkXMClduc7CyMELJXFcGKmpH4";
    private View root;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_architeture_frag);
        context = this;

        recyclerView = findViewById(R.id.recycler_view_arc_frag);
        progressBar = findViewById(R.id.progress_bar_arc_frag);
        toolbar = findViewById(R.id.toolbar_arc_f);
