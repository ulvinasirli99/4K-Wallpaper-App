...
public class FlowerFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "flower";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_flower_frag);
        context = this;

        recyclerView = findViewById(R.id.recycler_view_flow_frag);
        progressBar = findViewById(R.id.progress_bar_flow_frag);
        toolbar = findViewById(R.id.toolbar_flower_f);
