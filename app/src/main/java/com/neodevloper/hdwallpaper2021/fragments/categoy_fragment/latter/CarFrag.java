...
public class CarFrag extends AppCompatActivity {

    private ProgressBar progressBar;
    private Context context;
    private Toolbar toolbar;
    private static final String quest = "car";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_car_frag);
        context = this;
        recyclerView = findViewById(R.id.recycler_view_car_frag);
        progressBar = findViewById(R.id.progress_bar_car_frag);
        toolbar = findViewById(R.id.toolbar_car_f);
